...
//[slide#title]
icon:tv[] Open Source...is a no-brainer.

//[slide#brain-power]
icon:tv[] Actually, that's false.
Doing open source well and growing a successful ecosystem around it requires a lot of brain power.
...
Open Source is the best model for producing software.
...
//[slide#why]
icon:tv[] Perhaps it goes without saying, but if you want to grow, you gotta have an effort that's worth joining.
...
//[slide#amp]
icon:tv[] Open Source is created by people.
So to grow Open Source, you need to understand what motivates people.
...
You need to craft a call to adventure for the community, your hero.
...
Have a purpose and then communicate it.
...
icon:tv[] The way to generate activity is to constantly be engaging people.
...
Communication is 2-way, so LISTEN TO THEM!
...
//[slide#plus-one]
icon:tv[] Communication doesn't necessarily mean lots of words.
...
icon:tv[] The most important thing in OSS is to be honest, transparent and frank.
Share everything!
...
Without communication, they remain outsiders.
(Us vs them).
...
//[slide#bartosz]
icon:tv[] I've been working with OSS communities for a long time.
...
Two years earlier, Aslak Knutsen and I were walking with a newcomer to the Arquillian community, Bartosz Majsak.
...
(Why Bartosz wasn't with us when we left the apartment is a story for Bier Central).
...
icon:tv[] As I entered the room, the room monitor looked at me shaking her head.
...
Two years earlier, Bartosz viewed himself as just another person in the crowd, not worthy of note, and now, as a leader of the Arquillian project, I could barely get into the room to see him speak.
We believed in him before he was ready to believe in himself and he had become a celebrity.
...
Despite only having a “quicky” time slot, which run for 15 minutes, he turned over the stage to a developer he had met at the Hackergaten earlier in the week to talk share his work.
...
//[slide#no-evil]
icon:tv[] In 2012, Bartosz received a JBoss Community Award for his work on Arquillian and last year became the community manager for Arquillian.
...
//[slide#thank-you]
icon:tv[] _Thank you and good luck.
Namaste._
