...
Each experience has taught me lessons I want to share with you today.
I've waited a long time to tell this story.
I hope you'll be able to use this advice to make your community building efforts wildly successful and stand out from the crowd.
...
And people need to know where you're headed.
//A purpose.
...
I attended another talk before Bartosz's and got held up afterwards chatting with someone in the corridor, so I ended up being a few minutes late getting over to Bartosz's talk.
...
Despite only having a quicky time slot, which run for 15 minutes, he turned over the stage to a developer he had met at the hackergaten earlier in the week to talk about the project he works on.
