...
//[slide#title]
Open Source is a no-brainer (man).
...
Each experience has taught me lessons I am sharing with you today.
...
People need to know where you're headed.
//A purpose.
...
Every project starts out a ghost town.
...
The way to generate activity is to constantly be engaging people.
...
As I entered the room, the room monitor looked at me shaking her head.
...
//[slide#pool-creeper]
OSS is about you _not_ doing it alone.
...
There are ways to make this much less scary.
